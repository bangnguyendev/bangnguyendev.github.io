...
void lcd_put_cur(int row, int col)
{
    ...
    {
        case 0:
            col = LCD_SETDDRAMADDR | (col + 0x00);
            break;
        case 1:
            col = LCD_SETDDRAMADDR | (col + 0x40);
            break;
				case 2:
            col = LCD_SETDDRAMADDR | (col + 0x14);
            break;
        case 3:
            col = LCD_SETDDRAMADDR | (col + 0x54);
            break;
    }
    lcd_send_cmd (col);
}
...
...
lcd_send_cmd(0x40+00); // lênh cmd LCD_SETCGRAMADDR
