...
Từ sơ đồ nguyên lý, sử dụng I2C từ **STM32F4** truyền **8 bit** theo cấu trúc bit như sau:
...
<a href="/img/2023-07-23-I2C-LCD-STM32/Untitled 38.png" data-lightbox="roadtrip" data-title="My caption">
...
Nên **địa chỉ ghi dữ liệu** lên có giá trị `hex` như bảng dưới:
